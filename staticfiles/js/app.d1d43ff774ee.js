        ...
        17: function (e, t, n) {
            ...
            a()((function () {
                ...
                var e, t, n = a()("body"),
                    ...
                    B = null,
                    E = function () {
                        o.removeClass("submenu-is-active"), g.removeClass("active"), v.removeClass("opened").addClass("closed")
                    },
                    H = function () {
                    ...
                    V = function (e) {
                        Object(h.isMobile)() || (e ? (x.addClass("toggle-overflow"), _.addClass("toggle-overflow")) : (x.removeClass("toggle-overflow"), _.removeClass("toggle-overflow")))
                    };
                (i.on("click", (function () {
                    o.addClass("mobile-menu-opened"), f.addClass("opened"), H()
                })), d.on("click", (function () {
                    o.removeClass("mobile-menu-opened"), f.removeClass("opened"), H()
                })), g.on("click", (function () {
                    (D = !D) ? (o.addClass("submenu-is-active"), g.addClass("active"), v.removeClass("closed").addClass("opened")) : E()
                })), j.on("click", (function () {
                    y.addClass("opened"), setTimeout((function () {
                        C.trigger("focus")
                    }), 400), H()
                })), k.on("click", (function () {
                    ...
                    S.is(":checked") ? (a()("html").attr("data-theme", "dark"), localStorage.setItem("theme", "dark")) : (a()("html").attr("data-theme", "light"), localStorage.setItem("theme", "light"))
                ...
                })), L ? (a()("html").attr("data-theme", L), "dark" === L && S.attr("checked", !0)) : Object(h.isDarkMode)() && S.attr("checked", !0), o.length > 0) && new s.a(o[0], {
                    tolerance: {
                        down: 10,
                        up: 20
                    },
                ...
                if ("undefined" != typeof disableFadeAnimation && disableFadeAnimation ? a()("[data-aos]").addClass("no-aos-animation") : u.a.init({
                        once: !0,
                        startEvent: "DOMContentLoaded"
                    }), b.length > 0) {
                    var q = document.getElementById("secondary-navigation-template");
